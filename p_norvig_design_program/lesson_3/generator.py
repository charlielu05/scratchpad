...
# code below is generating the text instead of parsing/interpreting

def lit(s):         return lambda Ns: set([s]) if len(s) in Ns else null # Ns is the list of ints 
def alt(x, y):      return lambda Ns: set().union(x(Ns), y(Ns))
